...
*   **Operational Overhead ("Brown Time")**: {overhead_pct:.1f}%
...
*   **Impact:** Converting just half of the "Brown Time" to "Green Time" would increase capacity by {(overhead_pct/2):.1f}% without adding new hardware.
